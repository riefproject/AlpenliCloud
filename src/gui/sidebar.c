...
void updateSidebar(Sidebar *sidebar, Rectangle currentZeroPosition)
{
    ...
    sidebar->panelRec = (Rectangle){sidebar->currentZeroPosition.x, sidebar->currentZeroPosition.y + DEFAULT_PADDING + 24, 170, sidebar->currentZeroPosition.height - DEFAULT_PADDING - 24};
}
